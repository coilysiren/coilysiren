...
<td width="50%"><a href="https://forgejo.coilysiren.me/coilyco-flight-deck/housecast"><b>housecast</b></a> // <code>roster.yaml</code> - Agent context, cast from one roster<br><br>One YAML file declares every role. The bundle an agent gets and the scorecard that grades it are both cast from that file, so what gets tested and what ships are the same bundle.</td>
</tr>
<tr>
