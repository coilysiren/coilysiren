...
- **Four org bays** - `coilyco-flight-deck` (public builds), `coilyco-bridge` (operator-specific control surfaces), `coilyco-gaming` (games and game tooling), and `coilysiren` (personal: this repo and the website).
